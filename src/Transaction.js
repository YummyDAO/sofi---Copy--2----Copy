...
function DrawerAppBar(props) {
  ...
  const { data, error} = useSWR('loadCompleted', loadCompleted, {refreshInterval: 1000})
  const { data1, error1} = useSWR('loadBridged', loadBridged, {refreshInterval: 1000})
  const { data2, error2} = useSWR('loadPosts', loadPosts, {refreshInterval: 1000})
          ...
          <div className='container1'>
            <div className='row1'>
              <div className='bridge'>
                ...
                <Tooltip title="Supported ticker on transaction">
                ...
                <div className="Gik flex ti2">
                  <Typography className='lo21'>{multi}</Typography>
                  <Tooltip title="Copy deposit address">
                  <Button variant="text" className="tutu" onClick={copyq}>
                    < ContentCopyOutlinedIcon/>
                  </Button>
                  </Tooltip>
                </div>
                <Typography className='w1-bridgei ti2'>Recipent address</Typography>
                <Tooltip title="Recipent address">
